...
Editorial black & white with one red accent. See [`../ASSETS.md`](../ASSETS.md) for the
slot convention. Drop a correctly-named file here and it's picked up.
...
| Monogram | ⬜ | drop `monogram.svg` |
| App icon | ⬜ | drop `appicon.svg` |
